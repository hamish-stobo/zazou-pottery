...
const About = () => {
    return (
        <div className="about-wrapper" id="about">
            ...
            <Controller>
            <Scene triggerHook={0.7} triggerElement="#about img" duration={700} classToggle={['.adefault', 'fade-mainEls-in']} reverse={true} indicators={true}>
                {() => (
            ...
            <Scene triggerHook={0.7} triggerElement="#about h2" duration={700} classToggle={['.adefault1', 'fade-mainEls-in']} reverse={true} indicators={true}>
                {() => (
               <h2 className="adefault1">My Story</h2>
            )}
            </Scene>
            <Scene triggerHook={0.7} triggerElement="#about p" duration={700} classToggle={['.adefault3', 'fade-mainEls-in']} reverse={true} indicators={true}>
                {() => (
